...
/********************************************//**
* Generates [notphone][/notphone] shortcode which shows content on desktops or tablets
***********************************************/
...
/********************************************//**
* Generates [desktop][/desktop] shortcode which shows content on desktops only
***********************************************/
function wpmd_notdevice( $tats, $content="" ) {
	global $detect;
	if( ! $detect->isMobile() && ! $detect->isTablet() ) return do_shortcode($content);
}
add_shortcode( 'desktop', 'wpmd_notdevice' );
...
/********************************************//**
* Generates [ie][/ie] shortcode which shows content on Internet Explorer browsers only
***********************************************/
